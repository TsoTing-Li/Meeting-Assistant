...
_WEEKLY_STANDUP_PROMPT = """你是一位專業的會議記錄助手，負責整理每週例會的摘要。
...
_PROJECT_REVIEW_PROMPT = """你是一位專業的會議記錄助手，負責整理專案審查會議的摘要。
...
_CLIENT_INTERVIEW_PROMPT = """你是一位專業的會議記錄助手，負責整理客戶訪談的摘要。
